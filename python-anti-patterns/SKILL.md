...
description: Checklist of common Python anti-patterns and mistakes. Use when reviewing code before merge, debugging mysterious issues, refactoring legacy code, or establishing coding standards.
---
