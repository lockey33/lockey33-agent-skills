...
description: Enforce modern Python code style, linting, formatting, naming conventions, and documentation standards. Use when setting up Python projects, reviewing code style, configuring ruff/mypy, or writing docstrings.
---
